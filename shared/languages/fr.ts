export const FR = {
   ...
   LiberalismLevel5DescHTMLV2: "Tous les bâtiments obtiennent <b>+5 Renforcement du niveau de construction</b> grâce à l'électrification.",
   ...
   PinResourceTab: "Épingler l'onglet des ressources",
   Pizza: "Pizza",
   Pizzeria: "Pizzeria",
   ...
   PlayerTradeAddSuccess: "L'échange à été ajouté avec succès",
   ...
   ReadPatchNotesHTML: "Vous avez mis à jour <b>%{version}</b> (<b>%{build}</b>), lire les notes de patch sur <b>Steam</b>",
   ...
   SaintBasilsCathedralDescV2: "Permet aux bâtiments d'extraction de ressources de fonctionner lorsqu'ils sont adjacents à une ressource. Tous les bâtiments de catégorie I gagnent +1 Multiplicateur de Production, Multiplicateur de Capacité des Ouvriers et Multiplicateur de Stockage",
   Saladin: "Saladin",
   ...
   ShortcutUpgradePageCancelAllUpgrades: "Annuler toutes les améliorations",
   ...
   SourceIdeology: "Idéologie: %{ideology}",
   ...
   SwissBankDescV2:
      "Convertissez une ressource choisie dans les entrepôts adjacents en koti (10 millions en sanskrit), une ressource échangeable d'une valeur de 10 millions. Chaque niveau de la banque suisse ajoute 1 conversion de koti par cycle, qui est affectée par le multiplicateur de production. La banque suisse peut stocker un nombre illimité de koti.",
   Sword: "Épée",
   ...
   UpgradeBuildingNotProducingDescV2: "Ce bâtiment est en train d'être amélioré - <b>la production sera interrompue jusqu'à ce que l'amélioration soit terminée</b>",
